-- Couldn't vendor this because it needs attributes
script:SetAttribute("DefaultColor", Color3.new(1, 1, 1))
script:SetAttribute("DefaultScale", 1)
script:SetAttribute("DefaultThickness", 0.025)
